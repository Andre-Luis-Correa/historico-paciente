...
INSERT INTO paciente (numero_paciente, nome_paciente, data_nascimento_paciente, id_sexo, id_estado_civil, numero_documento_identidade_paciente, complemento_endereco_paciente, numero_endereco_paciente, id_endereco) VALUES
                                                                                                                                                                                                                          ('P001', 'Roberto Pereira', '1980-05-21', 1, 1, '123456789', 'Apto 101', '123', 1),
                                                                                                                                                                                                                          ('P002', 'Maria Vitoria Oliveira', '1985-11-15', 2, 2, '987654321', 'Apto 202', '456', 2),
                                                                                                                                                                                                                          ('P003', 'Francisco Souza', '1992-07-30', 1, 1, '567891234', 'Casa', '789', 1),
                                                                                                                                                                                                                          ('P004', 'Ana Paula Correa', '1975-09-10', 2, 2, '432198765', 'Casa', '321', 2),
                                                                                                                                                                                                                          ('P005', 'Fernanda Duarte', '1990-01-05', 2, 1, '345678912', 'Apto 303', '654', 1),
                                                                                                                                                                                                                          ('P006', 'Julia Silva', '1975-09-10', 2, 2, '432198765', 'Casa', '321', 2),
                                                                                                                                                                                                                          ('P007', 'Julio Roberto', '1975-09-10', 1, 2, '432198765', 'Casa', '321', 1);
...
INSERT INTO email_paciente (email_paciente, numero_paciente) VALUES
                                                                 ('roberto.pereira@example.com', 'P001'),
                                                                 ('roberto.pereira@gmail.com', 'P001'),
                                                                 ('roberto.pereira@hotmail.com', 'P001'),
                                                                 ('maria.vitoria@example.com', 'P002'),
                                                                 ('francisco.souza@example.com', 'P003'),
                                                                 ('ana.paula@example.com', 'P004'),
                                                                 ('fernanda.duarte@example.com', 'P005');
...
INSERT INTO exame_medico (numero_exame_medico, data_realizacao_exame_medico, codigo_tipo_exame_medico, id_resultado_geral_exame_medico, observacao_exame_medico, numero_paciente) VALUES
                                                                                                                                                                                      ...
                                                                                                                                                                                      (14, '2023-11-14', 'EX001', 1, 'Normal', 'P006');
...
INSERT INTO consulta_medica (numero_consulta_medica, data_realizacao_consulta_medica, crm_medico, codigo_diagnostico_cid, numero_paciente) VALUES
                                                                                                                                               ...
                                                                                                                                               (3, '2023-03-25', 'CRM003', null, 'P002'),
                                                                                                                                               (4, '2023-04-10', 'CRM001', 'D004', 'P002'),
                                                                                                                                               (5, '2023-05-05', 'CRM002', null, 'P003'),
                                                                                                                                               (6, '2023-06-12', 'CRM003', 'D001', 'P003'),
                                                                                                                                               (7, '2023-07-22', 'CRM001', null, 'P004'),
